...
public class CustomItem {
    ...
    public void renderItemIntoGUI(ItemStack stack, int x, int y) {
        ...
        ((CustomRenderItem) parent).getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
        ((CustomRenderItem) parent).getTextureManager().getTexture(TextureMap.locationBlocksTexture)
        ...
        ((CustomRenderItem) parent).callSetupGuiTransform(x, y, ibakedmodel.isGui3d());
        ...
        ((CustomRenderItem) parent).getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
        ((CustomRenderItem) parent).getTextureManager().getTexture(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
    }
    ...
    public void renderItem(ItemStack stack, IBakedModel model, boolean isInv) {
        if (stack != null) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                ((CustomRenderItem) parent).callRenderModel(model, stack);
    ...
    public void renderPot(IBakedModel model, int color) {
        ...
        ((CustomRenderItem) parent).getTextureManager().bindTexture(RES_ITEM_GLINT);
